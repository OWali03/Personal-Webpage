...
function isAuthorized(): boolean {
  try {
    ...
    // Check if /dua is in the permissions array
    return parsed.permissions.includes('/dua');
  } catch (error) {
    return false;
  }
}
...
<template>
  <div class="p-6 space-y-8 max-w-4xl mx-auto">
    ...
    <div class="text-center mb-8">
      <h1 class="text-4xl font-extrabold text-gray-800 mb-2">Dua Verses</h1>
      <p class="text-lg text-gray-600">A collection of supplications and verses</p>
    </div>

    <!-- Placeholder content - will be filled later -->
    <section class="bg-white p-6 rounded-lg shadow-md">
      <h2 class="text-2xl font-bold text-gray-800 mb-4">Content Coming Soon</h2>
      <p class="text-gray-700">
        Dua verses and supplications will be added here.
      </p>
    </section>
  </div>
</template>
